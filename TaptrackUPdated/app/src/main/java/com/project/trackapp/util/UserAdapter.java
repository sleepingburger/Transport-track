...
//    }
    ...
    public UserAdapter(@NonNull FirestoreRecyclerOptions<User> options, OnUserListener mOnUserListener,Context mCtx,boolean option) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull final UserHolder holder, int position, @NonNull User model) {
        ...
        holder.optionButton.setVisibility(option?View.VISIBLE:View.GONE);
    }
    @NonNull
    @Override
